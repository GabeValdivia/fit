...
class GymFitness_Classes_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Displays different classes offered inside the widget', 'text_domain' ), ) // Args
		);
	}
        ...
        <ul class="sidebar-classes-list">
            ...
            <li class="sidebar-class">
                ...
                <div class="class-content">
                    ...
                    ?>
                    <p><?php echo the_field('class_days') . " &mdash; " . $start_time . " to " . $end_time ?></p>
                </div>
